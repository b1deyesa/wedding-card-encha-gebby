...
document.addEventListener('DOMContentLoaded', function () {
    const slides = document.querySelector('.slides-4');
    const images = slides.querySelectorAll('img');
    const slideCount = images.length;
...
document.addEventListener('DOMContentLoaded', function () {
    const slides = document.querySelector('.slides-5');
    const images = slides.querySelectorAll('img');
    const slideCount = images.length;
...
document.addEventListener('DOMContentLoaded', function () {
    const slides = document.querySelector('.slides-6');
    const images = slides.querySelectorAll('img');
    const slideCount = images.length;
...
document.addEventListener('DOMContentLoaded', function () {
    const slides = document.querySelector('.slides-7');
    const images = slides.querySelectorAll('img');
    const slideCount = images.length;
...
document.addEventListener('DOMContentLoaded', function () {
    const slides = document.querySelector('.slides-8');
    const images = slides.querySelectorAll('img');
    const slideCount = images.length;
